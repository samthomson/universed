...
export function NewDMDrawer({ open, onOpenChange, onConversationCreated }: NewDMDrawerProps) {
    ...
    <Drawer open={open} onOpenChange={onOpenChange}>
      <DrawerContent className="pb-safe">
        <DrawerHeader className="text-left">
          <DrawerTitle>Start a Direct Message</DrawerTitle>
        </DrawerHeader>

        <div className="px-4 pb-4 space-y-4">
          <div className="space-y-2">
            <Label htmlFor="pubkey-mobile">User Pubkey, npub, or nprofile</Label>
            <Input
              id="pubkey-mobile"
              value={input}
